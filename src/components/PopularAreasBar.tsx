      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-1.5">
        ...
        <div className="flex items-center justify-between gap-2 overflow-x-auto no-scrollbar text-xs">
          <div className="flex items-center gap-1.5 shrink-0">
            <span className="flex items-center gap-1 text-[11px] font-bold text-slate-500 uppercase tracking-wider shrink-0 mr-0.5">
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-lg text-xs font-semibold transition cursor-pointer shrink-0 border ${
                selectedRegion === 'ALL'
          ...
          {onUseCurrentLocation && (
            <button
              ...
              disabled={isLocating}
              className="flex items-center gap-1 text-xs font-semibold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200/90 px-2.5 py-1 rounded-lg transition cursor-pointer shrink-0 ml-auto"
            ...
            {filteredLocations.map((loc: LocationPreset) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold transition-all duration-150 cursor-pointer shrink-0 border whitespace-nowrap ${
                    isCurrent
